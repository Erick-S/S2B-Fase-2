...
namespace MvcMovie.Controllers
{
    public class MovieController : Controller
    {
        ...
        public ViewResult Index(string searchString, string sortOrder, int? SelectedGenre)
        {
            ...
            ViewBag.RatingSortParam = sortOrder == "Rating" ? "rating_asc" : "Rating";
            switch (sortOrder)
            {
                case "Rating":
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(int id, string title, string director, DateTime releaseDate, decimal gross, double rating, string imageUrl, int genreID, HttpPostedFileBase image)
        {
        ...
        public ActionResult GetImage(int id)
        {
            ...
            {
                return new FilePathResult("~/Images/nao-disponivel.jpg",
               "image/jpeg");
            }
        }
